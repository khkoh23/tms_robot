...
void RosBridge::startTask(const QString & task_name, double tcp_offset_z_mm, double treatment_duration_sec, double min_distance_mm, const QString & force_mode) {
  ...
  goal.force_mode = force_mode.toStdString();
